    ...
    <Nav>
      <NavbarContainer>
        ...
        <NavItems>
          ...
          <NavLink href="#certificates">Certificates</NavLink> {/* Added Certificates */}
          <NavLink href="#contact">Contact</NavLink> {/* Added Contact */}
        </NavItems>
        <ButtonContainer>
        ...
        {isOpen && (
          <MobileMenu isOpen={isOpen}>
            ...
            <MobileMenuLink href="#certificates" onClick={() => setIsOpen(!isOpen)}>
              Certificates
            </MobileMenuLink> {/* Added Certificates */}
            <MobileMenuLink href="#contact" onClick={() => setIsOpen(!isOpen)}>
              Contact
            </MobileMenuLink> {/* Added Contact */}
            <GitHubButton
              style={{
                padding: '10px 16px',
